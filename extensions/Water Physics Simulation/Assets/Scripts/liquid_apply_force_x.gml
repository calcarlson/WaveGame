...
/*
    Applies a force, distributed between 2 nodes at a specific x
...
*/
    ...
    argument0.liquidarray[node1, 2] = argument2*(1-frac(sx));
    argument0.liquidarray[node2, 2] = argument2*frac(sx);
